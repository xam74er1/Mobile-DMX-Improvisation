...
// Names below are seeded once (in French, matching the app's default language)
// and become regular editable text the moment a user renames them — like any
// other ambiance/category, they are NOT re-translated on a language switch.
export const DEFAULT_CATEGORIES: AmbianceCategory[] = [
  { id: 'cat-colors',  name: 'Couleurs' },
  { id: 'cat-effects', name: 'Effets' },
]

export const DEFAULT_AMBIANCES: Ambiance[] = [
  // ── Static colors ──────────────────────────────────────────
  {
    id: 'amb-blue',   name: 'Bleu',   icon: 'wb-incandescent', categoryId: 'cat-colors',
    lightStates: { [L]: { r: 0,   g: 68,  b: 255, w: 0,   a: 0, uv: 0, intensity: 100, isOn: true } }, effects: [],
  },
  {
    id: 'amb-red',    name: 'Rouge',    icon: 'wb-incandescent', categoryId: 'cat-colors',
    lightStates: { [L]: { r: 255, g: 0,   b: 0,   w: 0,   a: 0, uv: 0, intensity: 100, isOn: true } }, effects: [],
  },
  {
    id: 'amb-green',  name: 'Vert',  icon: 'wb-incandescent', categoryId: 'cat-colors',
    lightStates: { [L]: { r: 0,   g: 200, b: 0,   w: 0,   a: 0, uv: 0, intensity: 100, isOn: true } }, effects: [],
  },
  {
    id: 'amb-white',  name: 'Blanc',  icon: 'wb-sunny',        categoryId: 'cat-colors',
    lightStates: { [L]: { r: 0,   g: 0,   b: 0,   w: 255, a: 0, uv: 0, intensity: 100, isOn: true } }, effects: [],
  },
  {
    id: 'amb-purple', name: 'Violet', icon: 'wb-incandescent', categoryId: 'cat-colors',
  ...
  {
    id: 'amb-strobe', name: 'Soirée Stroboscope', icon: 'flash-on', categoryId: 'cat-effects',
  ...
  {
    id: 'amb-beat', name: 'Rythme Musical', icon: 'music-note', categoryId: 'cat-effects',
  ...
  {
    id: 'amb-heartbeat', name: 'Battement de cœur', icon: 'flare', categoryId: 'cat-effects',
  ...
  {
    id: 'amb-police', name: 'Alerte', icon: 'blur-on', categoryId: 'cat-effects',
  ...
  {
    id: 'amb-breathe', name: 'Respiration Océan', icon: 'waves', categoryId: 'cat-effects',
  ...
  {
    id: 'amb-warm-breathe', name: 'Respiration Chaude', icon: 'wb-incandescent', categoryId: 'cat-effects',
  ...
  {
    id: 'amb-sunrise', name: 'Lever de soleil', icon: 'wb-sunny', categoryId: 'cat-effects',
  ...
  {
    id: 'amb-ramp-down', name: 'Fondu de sortie', icon: 'brightness-5', categoryId: 'cat-effects',
    lightStates: { [L]: { r: 255, g: 255, b: 255, w: 0, a: 0, uv: 0, intensity: 100, isOn: true } },
  ...
  {
    id: 'amb-flash', name: 'Coup de flash', icon: 'star', categoryId: 'cat-effects',
    lightStates: { [L]: { r: 255, g: 255, b: 255, w: 255, a: 0, uv: 0, intensity: 100, isOn: true } },
  ...
  {
    id: 'amb-colorfade', name: 'Bleu → Violet', icon: 'gradient', categoryId: 'cat-effects',
    lightStates: { [L]: { r: 0, g: 68, b: 255, w: 0, a: 0, uv: 0, intensity: 100, isOn: true } },
  ...
  {
    id: 'amb-clap', name: 'Applaudissements', icon: 'stars', categoryId: 'cat-effects',
    lightStates: { [L]: { r: 255, g: 255, b: 255, w: 255, a: 0, uv: 0, intensity: 100, isOn: true } },
  ...
  {
    id: 'amb-sunset', name: 'Coucher de soleil rouge', icon: 'filter-drama', categoryId: 'cat-effects',
